...
This application uses [json-server](https://github.com/typicodejson-server) to provide you with an API. To make sure it is installed, you will need to run the following commands:
